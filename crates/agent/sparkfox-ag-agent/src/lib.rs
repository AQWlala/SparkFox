...
// Re-export the skills crate so existing callers (sparkfox-ag-cli, tests) can use
// `sparkfox_ag_agent::skills::` without changing their import paths.
pub use sparkfox_ag_skills as skills;
