...
//! self-contained in the agent layer (writes via `sparkfox_ag_memory`); the host wires
...
use sparkfox_ag_memory::index::append_index_entry;
use sparkfox_ag_memory::paths::ENTRYPOINT_NAME;
use sparkfox_ag_memory::store::write_memory;
...
impl Tool for RememberTool {
    ...
    fn describe(&self, input: &Value) -> String {
        ...
        format!("Remember: {}", sparkfox_ag_tools::truncate_utf8(title, 60))
    }
}
