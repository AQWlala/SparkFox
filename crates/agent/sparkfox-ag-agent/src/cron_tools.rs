...
//! a concrete sink bound to the agent's conversation; standalone `sparkfox-ag-cli`
...
/// over its `CronService`, bound to the agent's conversation; `sparkfox-ag-agent` only
