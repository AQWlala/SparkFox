...
use sparkfox_ag_types::agent::{AgentInvocationInput, AgentInvocationOutput};
...
fn bounded_preview(value: &str, max_bytes: usize) -> String {
    ...
    let preview = sparkfox_ag_tools::truncate_utf8(&normalized, max_bytes);
...
mod tests {
    use super::*;
    use sparkfox_ag_types::agent::AgentToolPolicy;
