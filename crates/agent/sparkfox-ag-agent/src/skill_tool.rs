...
use sparkfox_ag_skills::context_modifier::ContextModifier;
use sparkfox_ag_skills::executor::{execute_fork, prepare_inline_content};
use sparkfox_ag_skills::hooks::{parse_skill_hooks, to_hook_defs};
use sparkfox_ag_skills::permissions::{SkillPermission, SkillPermissionChecker};
use sparkfox_ag_skills::types::{ExecutionContext, SkillMetadata};
use sparkfox_ag_types::agent::AgentInvocationRunner;
...
impl Tool for SkillTool {
    ...
    fn context_modifier_for(&self, input: &serde_json::Value) -> Option<ContextModifier> {
        ...
        sparkfox_ag_skills::context_modifier::from_skill(skill)
    }
...
mod tests {
    use super::*;
    use sparkfox_ag_skills::permissions::SkillPermissionChecker;
    use sparkfox_ag_skills::types::{ExecutionContext, LoadedFrom, SkillSource};
    use serde_json::json;
...
mod supplemental_tests {
    ...
    use sparkfox_ag_skills::permissions::SkillPermissionChecker;
    use sparkfox_ag_skills::types::{ExecutionContext, LoadedFrom, SkillMetadata, SkillSource};
