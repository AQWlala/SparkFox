...
use sparkfox_ag_agent::plan::prompt::plan_mode_instructions;
use sparkfox_ag_agent::plan::tools::{EnterPlanModeTool, ExitPlanModeTool};
use sparkfox_ag_protocol::events::ToolCategory;
use sparkfox_ag_tools::Tool;
use sparkfox_ag_tools::registry::ToolRegistry;
use sparkfox_ag_types::skill_types::PlanModeTransition;
use serde_json::json;
...
fn tc_3_6_e2e_02_plan_mode_and_compaction_independent() {
    use sparkfox_ag_agent::compact::micro::microcompact;
    use sparkfox_ag_agent::plan::state::PlanState;
