...
use sparkfox_ag_agent::confirm::ToolConfirmer;
use sparkfox_ag_agent::engine::AgentEngine;
use sparkfox_ag_agent::tool_execution::{ProviderToolAuthority, execute_tool_calls};
use sparkfox_ag_agent::output::OutputSink;
use sparkfox_ag_agent::output::null_sink::NullSink;
use sparkfox_ag_compact::CompactionLevel;
use sparkfox_ag_config::compat::ProviderCompat;
use sparkfox_ag_config::config::{Config, ProviderType, SessionConfig, ToolsConfig};
use sparkfox_ag_config::hooks::HooksConfig;
use sparkfox_ag_mcp::config::McpConfig;
use sparkfox_ag_providers::create_provider;
...
fn openai_config(api_key: &str) -> Config {
    Config {
        ...
        compact: sparkfox_ag_config::compact::CompactConfig::default(),
        plan: sparkfox_ag_config::plan::PlanConfig::default(),
        file_cache: sparkfox_ag_config::file_cache::FileCacheConfig::default(),
        hooks: HooksConfig::default(),
        bedrock: None,
        vertex: None,
        mcp: McpConfig::default(),
        logging: sparkfox_ag_config::logging::LoggingConfig::default(),
    }
}
...
impl sparkfox_ag_tools::Tool for FixedOutputTool {
    fn name(&self) -> &str {
        &self.name
    }
