...
use sparkfox_ag_agent::compact::auto::{BOUNDARY_PREFIX, autocompact, should_autocompact};
use sparkfox_ag_agent::compact::emergency::is_at_emergency_limit;
use sparkfox_ag_agent::compact::micro::{CLEARED_TOOL_RESULT, microcompact};
use sparkfox_ag_agent::compact::state::CompactState;
...
async fn autocompact_triggers_llm_summary() {
    ...
    let config = {
        ...
        sparkfox_ag_config::config::Config {
