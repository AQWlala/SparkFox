...
//!    adapts this trait to the engine's [`sparkfox_ag_browser_engine::firewall::EgressApprover`]).
//!
...
//! gateway (the GW2 `sparkfox_ag_browser_confirm` pending channel).
//!
//! # Security keystone
//!
...
use sparkfox_ag_browser_engine::firewall::{EgressApprover, EgressVerdict, PostPreview};
