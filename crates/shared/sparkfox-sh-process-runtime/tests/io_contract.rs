use sparkfox_sh_process_runtime::{ProcessEvent, OutputBuffer, OutputCursor, OutputStream};
...
fn output_encoding(events: &[ProcessEvent]) -> &sparkfox_sh_process_runtime::EncodingMetadata {
    match &events[0] {
