...
//! frontend is polling. See `sparkfox_be_workshop::agent_ops`.

use std::sync::Arc;

use sparkfox_be_common::{WorkshopAssetId, WorkshopNodeId};
use sparkfox_be_creation::{CreationInput, NewCreationTask};
use sparkfox_be_workshop::AgentOp;
use sparkfox_be_workshop::service::AssetQuery;
...
fn summarize_canvas(meta: &sparkfox_be_workshop::WorkshopCanvasMeta, doc: &Value) -> Value {
...
mod tests {
    use super::*;
    use sparkfox_be_common::WorkshopCanvasId;

    fn meta() -> sparkfox_be_workshop::WorkshopCanvasMeta {
        sparkfox_be_workshop::WorkshopCanvasMeta {
