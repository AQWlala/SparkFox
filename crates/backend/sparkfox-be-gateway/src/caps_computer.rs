...
//! in-tree `sparkfox_ag_computer::ComputerTool`, mirroring the inward
...
#[derive(Deserialize, JsonSchema)]
struct RefParams {
    /// Element number `[ref]` from the most recent `sparkfox_ag_computer_snapshot`.
    r#ref: u32,
}
...
pub(crate) fn register(out: &mut Vec<Capability>) {
    ...
    out.push(Capability::new::<ScreenshotParams, _, _>(
        CapabilityMeta::new(
            "sparkfox_ag_computer_screenshot",
            "computer",
    ...
    out.push(Capability::new::<RefParams, _, _>(
        CapabilityMeta::new(
            "sparkfox_ag_computer_right_click",
            "computer",
    ...
    out.push(Capability::new::<RefParams, _, _>(
        CapabilityMeta::new(
            "sparkfox_ag_computer_double_click",
            "computer",
    ...
    out.push(Capability::new::<SetValueParams, _, _>(
        CapabilityMeta::new(
            "sparkfox_ag_computer_set_value",
            "computer",
    ...
    out.push(Capability::new::<NoParams, _, _>(
        CapabilityMeta::new(
            "sparkfox_ag_computer_list_windows",
            "computer",
    ...
    out.push(Capability::new::<NoParams, _, _>(
        CapabilityMeta::new(
            "sparkfox_ag_computer_cursor_position",
            "computer",
