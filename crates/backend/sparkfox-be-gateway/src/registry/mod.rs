...
const RETIRED_COLLABORATION_TOOL_PREFIXES: &[&str] = &[
    ...
    "nomi_run_",
    "nomi_task_",
    "sparkfox_ag_agent_run_",
    "sparkfox_ag_agent_result_",
];
...
const RETIRED_COLLABORATION_TOOL_NAMES: &[&str] = &[
    ...
    "nomi_spawn",
    "sparkfox_ag_agent_run",
    "sparkfox_ag_agent_result",
];
...
impl Registry {
    ...
    fn build() -> Registry {
        ...
        //      wire it in sparkfox-be-app/src/router/routes.rs::inject_gateway_deps.
...
mod tests {
    use super::*;
    use sparkfox_be_api_types::GatewayMcpConfig;
    ...
    fn retired_collaboration_name_guard_covers_every_legacy_family() {
        for name in [
            ...
            "sparkfox_ag_agent_run",
            "sparkfox_ag_agent_result",
            "sparkfox_ag_agent_run_v2",
            "sparkfox_ag_agent_result_status",
            "nomi_run_create",
            "nomi_run_status",
            "nomi_run_result",
            "nomi_run_adjust",
