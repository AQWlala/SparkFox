...
//!
//! It is a thin facade over the in-tree `sparkfox_ag_computer::ComputerTool` — every
...
//! never pull xcap/enigo/UI Automation. The underlying `sparkfox-ag-a11y` backend is
...
use sparkfox_ag_computer::tool::ComputerTool;
