...
use sparkfox_be_common::{LoopbackCapabilityClaims, LoopbackCapabilityError};
use sparkfox_be_common::unix_time_secs;
...
pub async fn run_knowledge_stdio() -> ExitCode {
    ...
    let client_result = if managed_capability_present {
        ...
        let result = async {
            ...
            let control = sparkfox_be_knowledge::connect_external_knowledge_broker(&cwd).await?;
