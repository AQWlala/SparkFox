...
use sparkfox_be_common::validate_uuidv7;
...
impl Default for AppConfig {
    fn default() -> Self {
        Self {
            host: sparkfox_be_common::constants::DEFAULT_HOST.to_string(),
            port: sparkfox_be_common::constants::DEFAULT_PORT,
...
mod tests {
    ...
    fn storage_generation_is_stable_until_its_file_is_removed() {
        ...
        assert!(sparkfox_be_common::validate_uuidv7(&first).is_ok());
