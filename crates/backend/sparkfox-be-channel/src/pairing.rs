...
use sparkfox_be_api_types::{PairingRequestedPayload, UserAuthorizedPayload, WebSocketMessage};
use sparkfox_be_common::{TimestampMs, generate_prefixed_id, now_ms};
use sparkfox_be_db::IChannelRepository;
use sparkfox_be_db::models::{ChannelUserRow, ChannelPairingCodeRow};
...
mod tests {
    use super::*;
    use sparkfox_be_db::models::{ChannelSessionRow, ChannelUserRow, ChannelPluginRow, ChannelPairingCodeRow};
    use sparkfox_be_db::{DbError, IChannelRepository, UpdatePluginStatusParams};
    use std::sync::Mutex;
    ...
    /// (the assembly in sparkfox-be-app now starts it at boot).
