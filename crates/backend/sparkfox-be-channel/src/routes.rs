...
use sparkfox_be_extension::{ExtensionRegistry, ResolvedChannelPlugin};
...
fn corrupt_channel_id(
    field: &str,
    value: &str,
    error: sparkfox_be_common::PrefixedIdError,
) -> AppError {
...
mod tests {
    use super::*;
    use sparkfox_be_api_types::TestPluginExtraConfig;
