use sparkfox_be_common::{RemoteAgentAuthType, RemoteAgentId, RemoteAgentProtocol, RemoteAgentStatus, TimestampMs};
...
mod tests {
    ...
    use sparkfox_be_common::{RemoteAgentAuthType, RemoteAgentProtocol, RemoteAgentStatus};
    ...
    fn remote_agent_response_serializes_canonical_string_id() {
        let id = sparkfox_be_common::RemoteAgentId::new();
