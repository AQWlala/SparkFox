...
use sparkfox_be_common::{KnowledgeBaseId, TerminalId, TimestampMs};
...
mod tests {
    ...
    fn create_request_knowledge_base_ids_default_and_parse() {
        ...
        let kb_1 = sparkfox_be_common::KnowledgeBaseId::new();
        let kb_2 = sparkfox_be_common::KnowledgeBaseId::new();
