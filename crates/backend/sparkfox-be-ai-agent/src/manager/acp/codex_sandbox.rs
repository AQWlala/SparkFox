...
use sparkfox_be_common::{AppError, CommandSpec, EnvVar, ErrorChain};
use tokio::fs;
...
mod tests {
    ...
    fn metadata_with_backend(backend: Option<&str>) -> AgentMetadata {
        AgentMetadata {
            ...
            agent_type: sparkfox_be_common::AgentType::Acp,
            agent_source: sparkfox_be_api_types::AgentSource::Builtin,
            agent_source_info: sparkfox_be_api_types::AgentSourceInfo::default(),
            enabled: true,
            available: true,
            command: None,
            ...
            behavior_policy: sparkfox_be_api_types::BehaviorPolicy::default(),
            yolo_id: Some("full-access".into()),
            sort_order: 3110,
            handshake: sparkfox_be_api_types::AgentHandshake::default(),
        }
    }
...
"#,
        ...
        let mut spec = sparkfox_be_common::CommandSpec {
    ...
    async fn prepare_command_spec_uses_managed_codex_home() {
        ...
        let mut spec = sparkfox_be_common::CommandSpec {
            command: std::path::PathBuf::from("codex-acp"),
            args: vec![],
            env: vec![sparkfox_be_common::EnvVar {
