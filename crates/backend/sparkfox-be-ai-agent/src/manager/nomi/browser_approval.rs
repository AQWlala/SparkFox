...
//!
//! Implements the facade [`sparkfox_ag_browser::BrowserApprovalGate`] for the desktop/backend
...
use sparkfox_ag_browser::{ApprovalAsk, ApprovalDecision, BrowserApprovalGate};
use sparkfox_ag_protocol::events::ToolCategory;
use sparkfox_ag_protocol::{ToolApprovalManager, ToolApprovalResult};
use sparkfox_be_common::{Confirmation, ConfirmationOption, generate_id};
use serde_json::json;
...
mod tests {
    use super::*;
    use sparkfox_ag_browser::ApprovalKind;
    use sparkfox_ag_protocol::commands::{ApprovalScope, SessionMode};
