...
use sparkfox_be_db::{IAcpSessionRepository, SaveRuntimeStateParams};
...
impl AcpSessionSyncService {
    ...
    pub async fn load_persisted(&self, conversation_id: &str) -> Option<sparkfox_be_db::PersistedSessionState> {
...
mod tests {
    ...
    use sparkfox_be_db::{CreateAcpSessionParams, SqliteAcpSessionRepository, init_database_memory};
