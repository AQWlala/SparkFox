...
//! trait lives in `sparkfox-be-terminal` (the lower crate), this crate provides the
//! provider-backed implementation, and `sparkfox-be-app` wires it via
...
use sparkfox_be_terminal::TerminalTitleCompleter;
