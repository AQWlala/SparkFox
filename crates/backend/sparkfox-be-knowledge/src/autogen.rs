...
//! implementation lives in `sparkfox-be-ai-agent` (same layering as the companion
...
/// `sparkfox-be-companion`). The knowledge crate holds only the trait; provider/model
