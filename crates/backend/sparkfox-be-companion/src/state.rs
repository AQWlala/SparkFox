...
pub struct CompanionRouterState {
    ...
    pub preset_service: Option<Arc<sparkfox_be_preset::PresetService>>,
    pub knowledge_service: Option<Arc<sparkfox_be_knowledge::KnowledgeService>>,
}
...
impl CompanionRouterState {
    ...
    pub fn with_preset_service(mut self, service: Arc<sparkfox_be_preset::PresetService>) -> Self {
        self.preset_service = Some(service);
        self
    }

    pub fn with_knowledge_service(mut self, service: Arc<sparkfox_be_knowledge::KnowledgeService>) -> Self {
