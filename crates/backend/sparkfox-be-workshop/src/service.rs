...
//! under the data dir; index rows live in `sparkfox-be-db` via [`IWorkshopRepository`].
...
use sparkfox_be_db::{AssetSort, IWorkshopRepository, ListAssetsParams, UpdateAssetParams, WorkshopAssetRow};
...
mod tests {
    use super::*;
    use sparkfox_be_common::{WorkshopEdgeId, WorkshopNodeId};
    use sparkfox_be_db::SqliteWorkshopRepository;
