...
mod tests {
    use super::*;
    use sparkfox_be_db::models::{ConversationRow, CronJobRow};
    use sparkfox_be_db::{
    ...
    struct TestUserEventBus {
        sender: broadcast::Sender<sparkfox_be_api_types::WebSocketMessage<serde_json::Value>>,
    }
    ...
    impl TestUserEventBus {
        ...
        fn subscribe(
            &self,
        ) -> broadcast::Receiver<sparkfox_be_api_types::WebSocketMessage<serde_json::Value>> {
