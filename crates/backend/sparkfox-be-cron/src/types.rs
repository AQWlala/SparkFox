...
use sparkfox_be_common::{ConversationId, CronJobId, PresetId, ProviderId, TimestampMs, UserId};
use sparkfox_be_db::models::CronJobRow;
...
pub struct CronAgentConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub preset_snapshot: Option<sparkfox_be_api_types::ResolvedPresetSnapshot>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
