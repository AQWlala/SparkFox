use sparkfox_be_api_types::{ConversationArtifactResponse, WebSocketMessage};
use sparkfox_be_common::{ConversationArtifactId, ConversationId, CronJobId, UserId};
use sparkfox_be_db::ConversationArtifactRow;
...
mod tests {
    ...
    fn builds_skill_suggest_response() {
        ...
        assert_eq!(response.kind, sparkfox_be_api_types::ConversationArtifactKind::SkillSuggest);
        assert_eq!(response.status, sparkfox_be_api_types::ConversationArtifactStatus::Pending);
    ...
    fn builds_cron_trigger_payload() {
        ...
        let response = artifact_response_from_row(&row).unwrap();
        assert_eq!(response.kind, sparkfox_be_api_types::ConversationArtifactKind::CronTrigger);
