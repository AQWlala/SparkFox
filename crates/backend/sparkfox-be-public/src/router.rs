...
use sparkfox_be_auth::CompanionTokenValidator;
use sparkfox_be_common::CompanionId;
use sparkfox_be_gateway::GatewayDeps;
...
mod tests {
    ...
    use sparkfox_be_auth::token_sha256_hex;
    ...
    async fn valid_token_inserts_remote_companion_extension() {
        ...
        let companion_id = CompanionId::new();
        let validator = std::sync::Arc::new(sparkfox_be_auth::CompanionTokenValidator::new(vec![(
            companion_id.clone(),
