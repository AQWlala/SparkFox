...
use sparkfox_be_conversation::stream_relay::StreamRelay;
use sparkfox_be_db::{
    IConversationRepository, SortOrder, SqliteConversationRepository, init_database_memory, models::ConversationRow,
};
use sparkfox_be_realtime::WebSocketManager;
use serde_json::json;
use tokio::sync::broadcast;

async fn setup_repo() -> (Arc<SqliteConversationRepository>, sparkfox_be_db::Database, String, String) {
