...
///
/// Mirrors the strategy used by `sparkfox-be-preset::builtin`: the corpus is
/// authoritative at build time; an optional on-disk override
/// (`SPARKFOX_BUILTIN_SKILLS_PATH`) is consulted at runtime for rapid
/// iteration and E2E fixtures.
static BUILTIN_SKILLS: Dir<'static> =
    include_dir!("$CARGO_MANIFEST_DIR/../sparkfox-be-app/assets/builtin-skills");
...
pub const BUILTIN_SKILLS_ENV_VAR: &str = "SPARKFOX_BUILTIN_SKILLS_PATH";
