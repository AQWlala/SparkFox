...
//!
//! These tests exercise the public API surface of `sparkfox_be_extension::skill_service`
//! and `sparkfox_be_extension::external_paths` against the functional requirements in
//! `08-file-workspace.md` §B.

use std::path::Path;

use sparkfox_be_extension::external_paths::ExternalPathsManager;
use sparkfox_be_extension::skill_service::{
...
///
/// Production mode: no `SPARKFOX_BUILTIN_SKILLS_PATH` set — the built-in
