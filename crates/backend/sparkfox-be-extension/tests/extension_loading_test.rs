...
use sparkfox_be_extension::{ExtensionSource, ScanPath, filter_by_engine_compatibility, load_all};
...
//
// Since SPARKFOX_E2E_TEST=1 changes the behaviour of resolve_scan_paths()
