...
//!
//! These test the public API surface of `sparkfox_be_extension::manifest`.

use sparkfox_be_extension::{ExtensionError, ExtensionManifest, parse_manifest, validate_manifest};
