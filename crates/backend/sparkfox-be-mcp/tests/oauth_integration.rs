...
use sparkfox_be_db::{IOAuthTokenRepository, SqliteOAuthTokenRepository, UpsertOAuthTokenParams};
use sparkfox_be_mcp::McpOAuthService;
...
async fn check_status_authenticated_returns_true() {
    ...
    repo.upsert(UpsertOAuthTokenParams {
        ...
        expires_at: Some(sparkfox_be_common::now_ms() + 3_600_000),
    })
    .await
    .unwrap();
