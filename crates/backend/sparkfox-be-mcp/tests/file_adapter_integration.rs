...
use sparkfox_be_mcp::{McpAgentAdapter, McpServerTransport, NomifunAdapter};
...
mod nomifun {
    ...
    use sparkfox_be_db::{CreateMcpServerParams, DbError, IMcpServerRepository, UpdateMcpServerParams};
    ...
    impl IMcpServerRepository for MockRepo {
        ...
        async fn update(&self, _id: &sparkfox_be_common::McpServerId, _p: UpdateMcpServerParams<'_>) -> Result<McpServerRow, DbError> {
            unimplemented!()
        }

        async fn delete(&self, _id: &sparkfox_be_common::McpServerId) -> Result<(), DbError> {
            unimplemented!()
        }
        ...
        async fn update_status(
            ...
            _s: &str,
            _lc: Option<sparkfox_be_common::TimestampMs>,
        ) -> Result<(), DbError> {
            unimplemented!()
        }

        async fn update_tools(&self, _id: &sparkfox_be_common::McpServerId, _t: Option<&str>) -> Result<(), DbError> {
            unimplemented!()
        }
    }
...
mod opencode {
    use super::*;
    use sparkfox_be_mcp::OpencodeAdapter;
...
mod nomi {
    use super::*;
    use sparkfox_be_mcp::NomiAdapter;
