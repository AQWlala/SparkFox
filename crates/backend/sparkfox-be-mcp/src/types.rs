...
use sparkfox_be_api_types::{McpServerResponse, McpToolResponse, McpTransport};
...
///
/// Mirrors `McpTransport` from `sparkfox-be-api-types` but lives in the business
...
pub struct McpServer {
    ...
    pub id: sparkfox_be_common::McpServerId,
    pub name: String,
    pub description: Option<String>,
    pub enabled: bool,
...
mod tests {
    ...
    fn make_test_row(transport_type: &str, transport_config: &str, tools: Option<&str>, status: &str) -> McpServerRow {
        McpServerRow {
            id: sparkfox_be_common::McpServerId::parse("mcp_0190f5fe-7c00-7a00-8000-000000000123").unwrap(),
    ...
    fn into_response_with_tools() {
        ...
        assert_eq!(resp.id, sparkfox_be_common::McpServerId::parse("mcp_0190f5fe-7c00-7a00-8000-000000000123").unwrap());
