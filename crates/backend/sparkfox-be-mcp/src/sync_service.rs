...
use dashmap::DashMap;
use sparkfox_be_api_types::{DetectedMcpServerEntry, DetectedMcpServerResponse};
...
mod tests {
    ...
    use sparkfox_be_common::TimestampMs;
    ...
    impl IMcpServerRepository for MockRepo {
        ...
        async fn find_by_id(&self, _id: &sparkfox_be_common::McpServerId) -> Result<Option<McpServerRow>, DbError> {
            Ok(None)
        }
        ...
        async fn update(&self, _id: &sparkfox_be_common::McpServerId, _params: UpdateMcpServerParams<'_>) -> Result<McpServerRow, DbError> {
            unimplemented!("not needed for detection tests")
        }
        ...
        async fn update_tools(&self, _id: &sparkfox_be_common::McpServerId, _tools: Option<&str>) -> Result<(), DbError> {
            unimplemented!("not needed for detection tests")
        }
    }
