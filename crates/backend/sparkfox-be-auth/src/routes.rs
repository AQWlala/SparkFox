...
use sparkfox_be_common::{AppError, UserId};
use sparkfox_be_common::constants::SESSION_MAX_AGE_SECONDS;
use sparkfox_be_db::{IUserRepository, models::User};
...
/// it can pre-seed with `SPARKFOX_ADMIN_PASSWORD` (see
/// `sparkfox_be_app::bootstrap::ensure_admin_credentials`), which makes this return
