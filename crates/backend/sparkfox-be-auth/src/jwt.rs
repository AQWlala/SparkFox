...
const JWT_AUDIENCE: &str = "sparkfox-webui";
...
pub fn generate_random_secret_string() -> String {
    let mut buf = [0u8; 64];
    // getrandom failure is fatal — mirrors sparkfox-be-common's UUID generation.
...
mod tests {
    use super::*;
    use sparkfox_be_common::constants::COOKIE_MAX_AGE_DAYS;
