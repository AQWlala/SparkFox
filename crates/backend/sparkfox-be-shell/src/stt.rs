...
use sparkfox_be_api_types::{SpeechToTextConfig, SpeechToTextProvider, SpeechToTextResult};
use reqwest::Client;
...
impl SttService {
    ...
    pub fn new_dynamic() -> Self {
        Self {
            client: Arc::new(sparkfox_be_net::http_client),
        }
    }
...
mod tests {
    use super::*;
    use sparkfox_be_api_types::{DeepgramSpeechToTextConfig, OpenAISpeechToTextConfig};
