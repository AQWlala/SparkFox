...
use sparkfox_be_api_types::{PreviewHistoryTargetDto, PreviewSnapshotInfoDto, SnapshotContentResponse};
...
mod tests {
    use super::*;
    use sparkfox_be_common::PreviewContentType;
    ...
    fn compute_hash_extra_fields_differ() {
        let conversation_id = sparkfox_be_common::ConversationId::try_from(
