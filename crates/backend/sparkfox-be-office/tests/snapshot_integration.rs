use sparkfox_be_api_types::{PreviewHistoryTargetDto, PreviewSnapshotInfoDto};
use sparkfox_be_common::{ConversationId, PreviewContentType};
use sparkfox_be_office::SnapshotService;
