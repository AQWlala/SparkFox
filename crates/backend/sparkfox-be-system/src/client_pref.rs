...
use sparkfox_be_api_types::{ClientPreferencesResponse, UpdateClientPreferencesRequest};
...
mod tests {
    use super::*;
    use sparkfox_be_db::{SqliteClientPreferenceRepository, init_database_memory};
    use serde_json::json;
