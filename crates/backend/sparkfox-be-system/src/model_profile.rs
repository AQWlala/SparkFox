...
use sparkfox_be_db::{IModelProfileRepository, ModelProfileRow, UpsertModelProfileParams};
    ...
    S: AsRef<str> + Sync,
{
    ...
    for raw_model in models {
        ...
        let (tasks, traits) = sparkfox_be_api_types::derive_tasks_and_traits(platform, model);
