use sparkfox_be_common::{KnowledgeBaseId, KnowledgeBindingId};
use sqlx::SqlitePool;
...
mod tests {
    ...
    async fn binding_set_get_roundtrip() {
        ...
        let id1 = repo
            ...
            .await
            .unwrap();
        assert!(sparkfox_be_common::KnowledgeBindingId::parse(id1.clone()).is_ok());
    ...
    async fn binding_workpath_kind_and_empty_kb_ids() {
        ...
        let bid = repo
            ...
            .await
            .unwrap();
        assert!(sparkfox_be_common::KnowledgeBindingId::parse(bid).is_ok());
