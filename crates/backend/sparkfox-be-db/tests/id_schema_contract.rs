use sparkfox_be_common::{ConversationId, McpServerId, RemoteAgentId, TerminalId, WebhookId};
use sparkfox_be_db::{init_database_memory, installation_owner_id, validate_id_schema_contract};
use sqlx::Row;
