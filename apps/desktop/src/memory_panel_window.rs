...
pub async fn prepare_companion_memory_panel(app: tauri::AppHandle, server: tauri::State<'_, Arc<DesktopServer>>) -> Result<(), String> {
    ...
    run_on_main_thread_task(
        ...
        move || {
            ...
            tauri::WebviewWindowBuilder::new(&app_for_task, MEMORY_PANEL_LABEL, tauri::WebviewUrl::App("index.html#/sparkfox-memory-panel".into()))
                .title("SparkFox Memory")
