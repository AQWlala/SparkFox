...
import NomiScrollArea from '@/renderer/components/base/SparkScrollArea';
 ...
 * `sparkfox-free-model` provider. The provider itself is projected into all
          ...
          <div className='flex items-center gap-8px min-w-0'>
            ...
            <div className='min-w-0'>
              ...
              <div className='mt-2px text-13px leading-18px text-t-secondary'>
                {t('settings.modelHub.free.providerId', { id: status?.providerId ?? 'sparkfox-free-model' })}
              </div>
            </div>
          </div>
