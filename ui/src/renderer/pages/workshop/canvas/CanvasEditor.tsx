...
import { readAssetDrag, WORKSHOP_ASSET_DND, type WorkshopAssetDragPayload } from '../lib/dnd';
...
const CanvasInner: React.FC<CanvasEditorProps> = ({ canvasId, initialDoc, onSaveStateChange }) => {
  ...
  const onDragOver = useCallback((e: React.DragEvent) => {
    ...
    const hasPayload =
      Array.from(dt.types).includes('Files') || Array.from(dt.types).includes(WORKSHOP_ASSET_DND);
