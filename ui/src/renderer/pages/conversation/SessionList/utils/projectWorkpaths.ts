...
export const PROJECT_WORKPATHS_STORAGE_KEY = 'sparkfox:session-list-project-workpaths';
const PROJECT_WORKPATHS_CHANGED_EVENT = 'sparkfox:session-list-project-workpaths-changed';
