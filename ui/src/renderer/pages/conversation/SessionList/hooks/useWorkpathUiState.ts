 ...
 * - `sparkfox:workpath-pinned`              string[]; array order is the manual pin order
 * - `sparkfox:workpath-expansion`           Record<workpathKey, boolean>; drawers default to COLLAPSED
 * - `sparkfox:workpath-subgroup-expansion`  Record<`${workpathKey}:${kind}`, boolean>; subgroups default to EXPANDED
 * - `sparkfox:companion-group-expanded`     boolean; the 桌面伙伴 group defaults to EXPANDED
 */
export const WORKPATH_PINNED_STORAGE_KEY = 'sparkfox:workpath-pinned';
export const WORKPATH_EXPANSION_STORAGE_KEY = 'sparkfox:workpath-expansion';
export const WORKPATH_SUBGROUP_STORAGE_KEY = 'sparkfox:workpath-subgroup-expansion';
export const COMPANION_GROUP_STORAGE_KEY = 'sparkfox:companion-group-expanded';

const WORKPATH_UI_EVENT = 'sparkfox:workpath-ui-changed';
