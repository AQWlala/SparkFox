...
import NomiModal from '@/renderer/components/base/SparkModal';
...
const UpdateModal: React.FC = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('sparkfox-open-update-modal', handleOpenUpdateModal);

    return () => {
      removeOpenListener();
      window.removeEventListener('sparkfox-open-update-modal', handleOpenUpdateModal);
    };
  }, []);
