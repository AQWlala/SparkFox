...
const NomiModal: React.FC<NomiModalProps> = ({
  ...
  return (
    <Modal
      ...
      footer={null}
      onCancel={onCancel}
      className={`sparkfox-modal ${className}`}
      style={finalStyle}
      getPopupContainer={() => document.body}
    >
      <div className='sparkfox-modal-wrapper' style={{ borderRadius: borderRadiusVal }}>
        {renderHeader()}
        <div className='sparkfox-modal-body-content' style={bodyInlineStyle}>
          {children}
        </div>
        {renderFooter()}
      </div>
