...
export const WORKSPACE_TOGGLE_EVENT = 'sparkfox-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'sparkfox-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'sparkfox-workspace-has-files';
